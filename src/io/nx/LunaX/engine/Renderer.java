...
import io.nx.LunaX.engine.gfx.Color;
import io.nx.LunaX.engine.gfx.Font;
import io.nx.LunaX.engine.gfx.Image;
import io.nx.LunaX.engine.gfx.ImageRequest;
import io.nx.LunaX.engine.gfx.ImageTile;
import io.nx.LunaX.engine.gfx.Light;
import io.nx.LunaX.engine.gfx.LightRequest;
...
public class Renderer {
	...
	private int ambientColor = Color.RGBtoHex(35, 35, 35);
	...
	public void setPixel(int x, int y, int value) {
		...
		if ((x < 0 || x >= pW || y < 0 || y >= pH) || alpha == 0 || value == Color.RGBtoHex(255, 0, 255))
			return;
